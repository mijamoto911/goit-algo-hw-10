1. Quad method: The result obtained using the quad method uses numerical methods to approximate the integral. It is determined to be accurate within numerical calculations.
